...
public class CameraPreview extends ViewGroup {
    ...
    protected Rect calculateFramingRect(Rect container, Rect surface) {
        ...
        if(framingRectSize != null) {
            ...
            int horizontalMargin = Math.max(0, (intersection.width() - framingRectSize.width) / 3);
            int verticalMargin = Math.max(0, (intersection.height() - framingRectSize.height) / 3);
